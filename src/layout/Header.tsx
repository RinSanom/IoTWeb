        ...
        <div className="mx-auto max-w-7xl px-2 sm:px-4 lg:px-8 overflow-hidden">
          <div className="flex h-14 sm:h-16 lg:h-20 items-center justify-between w-full">
            ...
            >
              <Link
                href="/"
                className="flex items-center gap-1 sm:gap-2 lg:gap-3 group"
              >
              ...
              >
                {isAuthenticated ? (
                  ...
                  <AuthModal>
                    <Button
                      variant="outline"
                      className="bg-white/10 dark:bg-gray-800/70 backdrop-blur-sm hover:bg-gray-100 dark:hover:bg-gray-700"
                    >
                      Join with us
                    </Button>
                  </AuthModal>
