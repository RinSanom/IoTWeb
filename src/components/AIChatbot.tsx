  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px] h-[600px] flex flex-col p-0">
        <DialogHeader className="p-4 pb-2 border-b bg-gradient-to-r from-blue-50 to-purple-50">
                ...
                <div className="grid gap-2">
                  {suggestedQuestions.slice(0, 4).map((question, index) => (
                    <button
                      ...
                      className="text-left p-2 text-sm bg-blue-50 hover:bg-blue-100 rounded-lg border border-blue-200 transition-colors"
                    >
                      {question}
                    </button>
                  ))}
            ...
            {isStreaming && streamingMessage && (
              <div className="flex gap-3 justify-start">
                <div className="flex gap-2 max-w-[80%]">
                  ...
                  <div className="bg-gray-50 text-gray-900 border rounded-lg p-3">
                    ...
                    <div className="flex items-center justify-between mt-1">
                      ...
                      <p className="text-xs opacity-60 ml-2 text-blue-600 font-medium">
