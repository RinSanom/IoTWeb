...
function getHealthAdvice(aqi: number): string {
  ...
  if (aqi <= 150)
    return "Sensitive individuals should reduce outdoor exertion and avoid prolonged outdoor activities.";
  if (aqi <= 200)
    return "Everyone should limit outdoor exertion and avoid prolonged outdoor activities.";
  if (aqi <= 300)
    return "Everyone should avoid outdoor exertion. Stay indoors and keep windows closed.";
